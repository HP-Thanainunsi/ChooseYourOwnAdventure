  ...
  return (
    ...
    >
      ...
      {onRestart && (
        <button
          onClick={onRestart}
          className="mt-6 font-['Cinzel'] text-xs text-[#d4af37]/70 hover:text-[#fef08a] tracking-[0.2em] uppercase transition-all z-10 font-semibold"
        >
          [ ✦ RETURN TO CONCIERGE LOBBY ✦ ]
        </button>
      )}
    </div>
  );
